...
class ResetPasswordTokenValidate(GenericAPIView):
    """
    An Api View which provides a method to check the validity of a password
    reset token
    """
    throttle_classes = ()
    permission_classes = ()
...
reset_password_validate = ResetPasswordTokenValidate.as_view()
